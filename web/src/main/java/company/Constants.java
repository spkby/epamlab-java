...
public class Constants {
    ...
    public static final String INVALID_EMPLOYEE_DEPARTMENT = "Invalid employee department: ";
    public static final String INVALID_EMPLOYEE_SALARY = "Invalid employee salary: ";
    public static final String INVALID_HOLIDAY_EMPLOYEE = "Invalid holiday employee: ";
    public static final String INVALID_HOLIDAY_STATUS = "Invalid holiday status: ";
    public static final String INVALID_ROLE_NAME = "Invalid role name: ";
    public static final String LENGTH_MORE_10 = "length more 10";
    public static final String INVALID_SALARY_QUANTITY = "Invalid salary quantity: ";
    public static final String NON_POSITIVE_QUANTITY = "non-positive, quantity: ";
    public static final String INVALID_STATUS_NAME = "Invalid status name: ";
